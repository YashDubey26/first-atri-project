...
class Atri:
	def __init__(self, state: Any):
		...
		self.Website_Header = state["Website_Header"]
		self.Div1 = state["Div1"]
		self.Flex4 = state["Flex4"]
		self.Main_Content_Flex = state["Main_Content_Flex"]
		self.Main_content = state["Main_content"]
	...
	def Website_Header(self):
		self._getter_access_tracker["Website_Header"] = {}
		return self._Website_Header
	@Website_Header.setter
	def Website_Header(self, new_state):
		self._setter_access_tracker["Website_Header"] = {}
		global default_state
		self._Website_Header = Flex(new_state, default_state["Website_Header"])
	...
	@property
	def Main_Content_Flex(self):
		self._getter_access_tracker["Main_Content_Flex"] = {}
		return self._Main_Content_Flex
	@Main_Content_Flex.setter
	def Main_Content_Flex(self, new_state):
		self._setter_access_tracker["Main_Content_Flex"] = {}
		global default_state
		self._Main_Content_Flex = Flex(new_state, default_state["Main_Content_Flex"])

	@property
	def Main_content(self):
		self._getter_access_tracker["Main_content"] = {}
		return self._Main_content
	@Main_content.setter
	def Main_content(self, new_state):
		self._setter_access_tracker["Main_content"] = {}
		global default_state
		self._Main_content = Div(new_state, default_state["Main_content"])
	...
	def _to_json_fields(self):
		return {
			"Website_Header": self._Website_Header,
			"Div1": self._Div1,
			"Flex4": self._Flex4,
			"Main_Content_Flex": self._Main_Content_Flex,
